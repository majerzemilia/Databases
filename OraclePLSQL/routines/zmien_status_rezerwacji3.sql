...
zmien_status_rezerwacji3(id_rezerwacji NUMBER, ob_status CHAR) AS
czy_istnieje INT;
st_status CHAR(1);
...
wycieczkę');
 ...
 ELSE null;
 END CASE;
 SELECT w.ID_WYCIECZKI into ZMIEN_STATUS_REZERWACJI3.id_wycieczki FROM WYCIECZKI w
join REZERWACJE r
 ...
 WHERE w.ID_WYCIECZKI = ZMIEN_STATUS_REZERWACJI3.id_wycieczki;
 COMMIT;
end;