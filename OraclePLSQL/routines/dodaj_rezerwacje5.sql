...
dodaj_rezerwacje5(id_wycieczki NUMBER, id_osoby NUMBER) AS
czy_istnieje INT;
BEGIN
SELECT COUNT(*) INTO czy_istnieje FROM OSOBY o where o.ID_OSOBY =
dodaj_rezerwacje5.id_osoby;
...
w.ID_WYCIECZKI = dodaj_rezerwacje5.id_wycieczki;
IF czy_istnieje = 0 THEN
...
dodaj_rezerwacje5.id_osoby and r.ID_WYCIECZKI = dodaj_rezerwacje5.id_wycieczki;
IF czy_istnieje > 0 THEN
 raise_application_error(-20003, 'Rezerwacja już istnieje');
end if;
INSERT INTO REZERWACJE (id_wycieczki, id_osoby, STATUS)
VALUES (dodaj_rezerwacje5.id_wycieczki, dodaj_rezerwacje5.id_osoby, 'N');
COMMIT;
end;
