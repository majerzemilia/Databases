...
zmien_status_rezerwacji5(id_rezerwacji NUMBER, ob_status CHAR) AS
czy_istnieje INT;
st_status CHAR(1);
BEGIN
...
id_rezerwacji;
 ...
 SELECT COUNT(*) INTO czy_istnieje from WYCIECZKI_PRZYSZLE wp JOIN REZERWACJE r
on wp.ID_WYCIECZKI = r.ID_WYCIECZKI
